...
public class AlgMultiarranque_Clase02_Grupo06 {
    private final Randon_Clase02_Grupo06 rand;
    private StringBuilder log;

    public AlgMultiarranque_Clase02_Grupo06(long semilla) {
    ...
    void multiarranque(int iteracion, double probabilidad, float porcentajeAleatorio, int k, int dimension, Float valorMin, Float valorMax, String funcion, int elementosTabu, int divisiones) {
        log.append("INICIO EJECUCION: Algoritmo BUSQUEDA TABU CON VNS\n");
