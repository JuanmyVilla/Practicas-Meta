...
public class AlgBusquedaTabu_Clase02_Grupo06 {
    private final Randon_Clase02_Grupo06 rand;
    private StringBuilder log;

    public AlgBusquedaTabu_Clase02_Grupo06(long semilla) {
    ...
    void busquedatabu(int iteracion, double probabilidad, float porcentajeAleatorio, int k, int dimension, Float valorMin, Float valorMax, String funcion, int elementosTabu, int divisiones) {
        ...
        while (it < iteracion) {
            ...
            log.append("Iteracion: " + it + ". Numero NO mejoras: " + it2 + ". Coste MEJOR SOLUCION: " + mejorCosteGlobal + ". Coste SOLUCION ACTUAL: " + mejorCoste + "\n");
        ...
        log.append("\n" + "Coste Final BUSQUEDA TABU: " + mejorCosteGlobal + "\n");
