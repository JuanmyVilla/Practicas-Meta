...
public class AlgoritmoDiferencial_Clase02_Grupo06 {
    private final Randon_Clase02_Grupo06 rand;
    private StringBuilder log;

    public AlgoritmoDiferencial_Clase02_Grupo06(long semilla) {
    ...
    public void EvolucionDiferencial(int evaluaciones, int poblacion, int dimension, Float valorMin, Float valorMax, String funcion, float factorrecombinacion, String tipoMape, ArrayList<double[]> observaciones) {
        ...
        while (it < evaluaciones) {
            for (int k = 0; k < poblacion; k++) {
                ...
                Cromosoma_Clase02_Grupo06 objetivo = new Cromosoma_Clase02_Grupo06(poblacionInicial[indiceobjetivo]);
                ...
                if (posiblemejor < poblacionInicial[k].getCoste()) {
                    nuevaPoblacion[k] = new Cromosoma_Clase02_Grupo06(cromfinal, posiblemejor);
                } else {
                    nuevaPoblacion[k] = new Cromosoma_Clase02_Grupo06(poblacionInicial[k]);
                }
            }
            ...
            if (nuevaPoblacion[mejorpoblacion].getCoste() < mejorCromosomaGlobal.getCoste()) {
                mejorCromosomaGlobal = new Cromosoma_Clase02_Grupo06(nuevaPoblacion[mejorpoblacion]);
            }
    ...
    void generaPoblacionInicial(Cromosoma_Clase02_Grupo06[] poblacion, int tampoblacion, int dimension, Float valorMin, Float valorMax, String funcion, String tipoMape, ArrayList<double[]> observaciones) {
        for (int i = 0; i < tampoblacion; i++) {
            ...
            poblacion[i] = new Cromosoma_Clase02_Grupo06(vinicio, evaluacion(vinicio, funcion, tipoMape, observaciones));
        }
    }
...
//        }
    ...
    Cromosoma_Clase02_Grupo06 mutacion(Cromosoma_Clase02_Grupo06 hijo, float probabilidadMutacion, int dimension, float min, float max, String funcion) {
